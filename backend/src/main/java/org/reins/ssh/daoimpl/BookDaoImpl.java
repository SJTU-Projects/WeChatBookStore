...
//    private BookRepository bookRepository;
    ...
    public  Book findbook(Integer id)
    {
        ...
        List<Book> list = sessionFactory.openSession().createQuery("from Book where id=1").list();
        Book book1 = null;
        //        if(book!=null)
//        {
...
//        }
    ...
    {
        List<Book> list = sessionFactory.openSession().createQuery("from Book ").list();
        //Book book1 = null;
        //        if(book!=null)
//        {
//            System.out.println( "  "+ book.getName() );
...
//        System.out.println( "  "+ count );
        for (Book book:
                list) {
            //book1=book;
            int tmpid= Math.toIntExact(book.getId());
            System.out.println(tmpid + " book ");
            Optional<Bookicon> icon = bookIconRepository.findById(tmpid);
            if (icon.isPresent()){
                System.out.println("Not Null " + tmpid);
                if(book!=null)
                {
